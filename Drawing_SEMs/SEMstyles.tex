...
\usepackage{mathastext}                     % applied to maths mode
...
residual2/.style = {minimum width = 0.5pt, minimum height = 1.5mm,
   inner sep = 0pt},
regression/.style = {-{Stealth[length = 1.5mm]}, shorten > = 1pt, 
   inner sep = 1.5pt},
covariance/.style={{Stealth[length = 1.5mm]}-{Stealth[length = 1.5mm]}, 
   shorten > = 1pt, shorten < = 1pt, inner sep = 1.5pt},
variance/.style={{Stealth[length = 1mm]}-{Stealth[length = 1mm]}, 
