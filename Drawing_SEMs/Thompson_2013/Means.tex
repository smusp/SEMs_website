...
\path [variance] (F1.120) edge ["c$_{F1}$", above, outer sep = 1pt,
   bend left = 110, looseness = 3] (F1.60);
\path [variance] (F2.120) edge ["c$_{F2}$", above, outer sep = 1pt,
   bend left = 110, looseness = 3] (F2.60);
