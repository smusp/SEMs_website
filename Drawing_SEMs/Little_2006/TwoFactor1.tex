...
\path [variance] (POS.120) edge ["$\upphi_{11}\!=\!1$", above, outer sep = 1pt, bend left = 110, looseness = 3] (POS.60);
\path [variance] (NEG.120) edge ["$\upphi_{22}\!=\!1$", above, outer sep = 1pt, bend left = 110, looseness = 3] (NEG.60);
...
\path [regression, black!30] (M) edge ["$\upkappa_1\!=\!0$", pos = .6] (POS);
\path [regression, black!30] (M) edge ["$\upkappa_2\!=\!0$", pos = .6] (NEG);
