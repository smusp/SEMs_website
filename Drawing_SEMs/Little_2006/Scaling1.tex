...
\path [variance] (POS7.120) edge ["$\upphi_{7,11}\!=\!1$", above, outer sep = 1pt,
   bend left = 100, looseness = 2.5] (POS7.60);
\path [variance] (NEG7.120) edge ["$\upphi_{7,22}\!=\!1$", above, outer sep = 1pt,
...
\path [regression] (NEG7) edge ["$\uplambda_6$"] (neg73.00);
...
\path [regression, black!30] (M8) edge ["$\uptau_3$"] (pos83.south east);

\path [regression, black!30] (M8) edge ["$\uptau_4$"] (neg81.south west);
