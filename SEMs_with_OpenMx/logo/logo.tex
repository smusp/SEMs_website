...
\tikzset{
every edge quotes/.style = {fill = orange},
...
\path [regression] (X.70) edge ["\large{a}", above left] (M.250);
...
%% Label
\draw (0, -1.1) node [text = white] {\bf\large{SEMs with OpenMx}};

%% Guinea Pig logo
\node[inner sep = 0pt] (GuineaPig) at (0, 0.35)
{\includegraphics[width = .1\textwidth]{OpenMxguineapig.png}};
